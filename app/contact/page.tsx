...
import { 
  ...
  CheckCircle2, MapPin, Calendar, Menu, X 
} from 'lucide-react';
...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-6xl mx-auto px-6 py-12 md:py-20 font-serif">
        {/* HEADER */}
        ...
        <div className="grid md:grid-cols-5 gap-12 md:gap-16">
          ...
          <div className="md:col-span-3">
            <form onSubmit={handleSubmit} className="space-y-6 font-sans">
              ...
              {status === 'error' && (
                <div className="p-4 bg-red-50 border border-red-200 rounded-md font-serif">
          ...
          <div className="md:col-span-2 space-y-8 font-serif">
            <div>
              ...
              <div className="space-y-4 font-sans">
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="text-gray-900 group-hover:text-gray-600 break-all text-sm">
                ...
                <div className="flex items-start gap-3 p-4 bg-gray-50 border border-gray-200 rounded-md">
                  ...
                  <div>
                    ...
                    <div className="text-gray-900 text-sm">Panvel, Maharashtra, IN</div>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 p-4 bg-gray-50 border border-gray-200 rounded-md">
                  ...
                  <div>
                    ...
                    <div className="text-gray-900 text-sm">Open to opportunities</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="p-6 bg-gray-900 rounded-sm text-white">
              <h3 className="font-semibold mb-2 font-sans">Response Time</h3>
      ...
      <footer className="border-t border-gray-200 py-12 mt-20 font-sans">
